...
export const Navbar = () => {
  ...
  return (
    <header
      className={`z-10 flex w-full flex-row justify-between md:fixed bg-gradient-to-b from-background-950 ${
    ...
    >
      <div className={"flex flex-row items-center space-x-6 p-4"}>
        ...
        <p className="text-xs text-font-50 md:text-sm ">Browse by Language</p>
      </div>
