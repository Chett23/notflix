...
const EpisodeCarosel = ({ episodes, header }) => {
  ...
  return (
    <div className="flex w-full flex-col items-start">
      ...
      <div className="scrollbar-hide flex max-w-full overflow-x-scroll flex-row gap-4 p-6 ">
        {episodes.map((episode, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 z-10 flex cursor-pointer flex-col justify-between gap-2 self-center rounded-md px-2 py-4 text-left opacity-0 group-hover:opacity-100">
